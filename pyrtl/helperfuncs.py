...
def wire_struct(wire_struct_spec):
    ...
    def _init(
        ...
        **kwargs,
        ...
        """
        # Special case: Replace a "_value" kwarg with the actual class name. This
        # kwarg is useful when the class_name is not statically known.
        if "_value" in kwargs:
            kwargs[class_name] = kwargs["_value"]
            del kwargs["_value"]
    ...
    def _getattr(self, component_name: str):
        ...
        return WrappedWireVector.__getattr__(self, component_name)
    ...
    return type(
        ...
        (WrappedWireVector,),
        {
            ...
            "__len__": _len,
            "__doc__": wire_struct_spec.__doc__,
        },
    )


def wire_matrix(component_schema, size: int, class_name: str | None = None):
    ...
    accessed by combining the ``[]`` and ``.`` operators::
        ...
        class Byte:
            high: 4
            low: 4
        Array1D = wire_matrix(component_schema=Byte, size=2, class_name="Array1D")
    ...
    .. NOTE::
        ...
        simulation time.
    """
    # Users may specify the name of the returned class.
    if class_name is None:
        class_name = "_WireMatrix"
