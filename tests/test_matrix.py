...
class TestMultiply(unittest.TestCase):
    ...
    def test_multiply_scalar(self):
        ...
        result_matrix = pyrtl.multiply(first_matrix, b_input)
    ...
    def test_multiply_matrix(self):
        ...
        result_matrix = pyrtl.multiply(first_matrix, second_matrix)
    ...
    def test_multiply_fail_string(self):
        with self.assertRaises(pyrtl.PyrtlError):
            ...
            second_matrix = pyrtl.Matrix(
                3, 3, 4, value=int_matrix)
            result_matrix = pyrtl.multiply(1, second_matrix)
...
class Testsummation(unittest.TestCase):
    ...
    def test_summation_basic(self):
        self.summation([[0]], 1, 1, 2, None)

    def test_summation_basic_column(self):
        self.summation([[0]], 1, 1, 2, 0)

    def test_summation_basic_row(self):
        self.summation([[0]], 1, 1, 2, 1)

    def test_summation_3_by_3(self):
        self.summation([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, None)

    def test_summation_3_by_3_column(self):
        self.summation([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 0)

    def test_summation_3_by_3_row(self):
        self.summation([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 1)

    def test_summation_4_by_1(self):
        self.summation([[0], [1], [0], [1]], 4, 1, 4, None)

    def test_summation_4_by_1_column(self):
        self.summation([[0], [1], [0], [1]], 4, 1, 4, 0)

    def test_summation_4_by_1_row(self):
        self.summation([[0], [1], [0], [1]], 4, 1, 4, 1)

    def test_summation_1_by_4(self):
        self.summation([[0, 1, 0, 1]], 1, 4, 4, None)

    def test_summation_1_by_4_column(self):
        self.summation([[0, 1, 0, 1]], 1, 4, 4, 0)

    def test_summation_1_by_4_row(self):
        self.summation([[0, 1, 0, 1]], 1, 4, 4, 1)

    def test_summation_random_case(self):
        ...
        self.summation(matrix, rows, columns, bits, axis)

    def test_summation_wire(self):
        wire = pyrtl.Const(3)
        summation_wire = pyrtl.Output(name="output", bitwidth=len(wire))
        summation_wire <<= pyrtl.summation(wire)
    ...
    def test_summation_fail_string(self):
        with self.assertRaises(pyrtl.PyrtlError):
            output = pyrtl.summation("1", 0)

    def test_summation_fail_negative_axis(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.summation(matrix, -1)

    def test_summation_fail_axis_out_of_bounds(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.summation(matrix, 2)

    def test_summation_fail_string_axis(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.summation(matrix, "0")

    def test_summation_fail_string_bits(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.summation(matrix, axis=0, bits="0")

    def test_summation_fail_negative_bits(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.summation(matrix, axis=0, bits=-1)

    def test_summation_fail_zero_bits(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.summation(matrix, axis=0, bits=0)

    def summation(self, int_matrix, rows, columns, bits, axis):
        matrix = pyrtl.Matrix(
            rows, columns, bits, value=int_matrix, max_bits=bits * rows)

        result = pyrtl.summation(
...
class TestMin(unittest.TestCase):
    ...
    def test_minimum_basic(self):
        self.minimum([[0]], 1, 1, 2, None)

    def test_minimum_basic_column(self):
        self.minimum([[0]], 1, 1, 2, 0)

    def test_minimum_basic_row(self):
        self.minimum([[0]], 1, 1, 2, 1)

    def test_minimum_3_by_3(self):
        self.minimum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, None)

    def test_minimum_3_by_3_column(self):
        self.minimum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 0)

    def test_minimum_3_by_3_row(self):
        self.minimum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 1)

    def test_minimum_4_by_1(self):
        self.minimum([[0], [1], [0], [1]], 4, 1, 4, None)

    def test_minimum_4_by_1_column(self):
        self.minimum([[0], [1], [0], [1]], 4, 1, 4, 0)

    def test_minimum_4_by_1_row(self):
        self.minimum([[0], [1], [0], [1]], 4, 1, 4, 1)

    def test_minimum_1_by_4(self):
        self.minimum([[0, 1, 0, 1]], 1, 4, 4, None)

    def test_minimum_1_by_4_column(self):
        self.minimum([[0, 1, 0, 1]], 1, 4, 4, 0)

    def test_minimum_1_by_4_row(self):
        self.minimum([[0, 1, 0, 1]], 1, 4, 4, 1)

    def test_minimum_random_case(self):
        rows, columns, bits, axis = random.randint(
            1, 5), random.randint(1, 5), random.randint(1, 5), random.randint(0, 2)
        if axis == 2:
            axis = None
        ...
        self.minimum(matrix, rows, columns, bits, axis)

    def test_minimum_wire(self):
        wire = pyrtl.Const(3)
        summation_wire = pyrtl.Output(name="output", bitwidth=len(wire))
        summation_wire <<= pyrtl.minimum(wire)
    ...
    def test_minimum_fail_string(self):
        with self.assertRaises(pyrtl.PyrtlError):
            output = pyrtl.minimum("1", 0)

    def test_minimum_fail_axis_out_of_bounds(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.minimum(matrix, 4)

    def test_minimum_fail_axis_negative(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.minimum(matrix, -1)

    def test_minimum_fail_axis_string(self):

        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.minimum(matrix, "0")

    def test_minimum_fail_bits_string(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.minimum(matrix, axis=0, bits="1")

    def test_minimum_fail_bits_zero(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.minimum(matrix, axis=0, bits=0)

    def test_minimum_fail_bits_negative(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.minimum(matrix, axis=0, bits=-2)

    def minimum(self, int_matrix, rows, columns, bits, axis):
        matrix = pyrtl.Matrix(
            rows, columns, bits, value=int_matrix, max_bits=bits * rows)

        result = pyrtl.minimum(
            matrix, axis=axis, bits=bits * max(rows, columns))
        output = pyrtl.Output(name="output", bitwidth=len(result))
        if axis is None:
            output <<= result
...
class TestMax(unittest.TestCase):
    ...
    def test_maximum_basic(self):
        self.maximum([[0]], 1, 1, 2, None)

    def test_maximum_basic_columns(self):
        self.maximum([[0]], 1, 1, 2, 0)

    def test_maximum_basic_rows(self):
        self.maximum([[0]], 1, 1, 2, 1)

    def test_maximum_3_by_3(self):
        self.maximum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, None)

    def test_maximum_3_by_3_columns(self):
        self.maximum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 0)

    def test_maximum_3_by_3_rows(self):
        self.maximum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 1)

    def test_maximum_4_by_1(self):
        self.maximum([[0], [1], [0], [1]], 4, 1, 4, None)

    def test_maximum_4_by_1_columns(self):
        self.maximum([[0], [1], [0], [1]], 4, 1, 4, 0)

    def test_maximum_4_by_1_rows(self):
        self.maximum([[0], [1], [0], [1]], 4, 1, 4, 1)

    def test_maximum_1_by_4(self):
        self.maximum([[0, 1, 0, 1]], 1, 4, 4, None)

    def test_maximum_1_by_4_columns(self):
        self.maximum([[0, 1, 0, 1]], 1, 4, 4, 0)

    def test_maximum_1_by_4_rows(self):
        self.maximum([[0, 1, 0, 1]], 1, 4, 4, 1)

    def test_maximum_random_case(self):
        rows, columns, bits, axis = random.randint(
            1, 5), random.randint(1, 5), random.randint(1, 5), random.randint(0, 2)
        if axis == 2:
            axis = None
        ...
        self.maximum(matrix, rows, columns, bits, axis)

    def test_maximum_wire(self):
        wire = pyrtl.Const(3)
        maximum_wire = pyrtl.Output(name="output", bitwidth=len(wire))
        maximum_wire <<= pyrtl.maximum(wire)
    ...
    def test_maximum_fail_string(self):
        with self.assertRaises(pyrtl.PyrtlError):
            output = pyrtl.maximum("1", 0)

    def test_maximum_fail_axis_out_of_bounds(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.maximum(matrix, 4)

    def test_maximum_fail_axis_negative(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.maximum(matrix, -1)

    def test_maximum_fail_axis_string(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.maximum(matrix, "0")

    def test_maximum_fail_bits_string(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.maximum(matrix, axis=0, bits="1")

    def test_maximum_fail_bits_zero(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.maximum(matrix, axis=0, bits=0)

    def test_maximum_fail_bits_negative(self):
        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.maximum(matrix, axis=0, bits=-1)

    def maximum(self, int_matrix, rows, columns, bits, axis):
        matrix = pyrtl.Matrix(
            rows, columns, bits, value=int_matrix, max_bits=bits * rows)

        result = pyrtl.maximum(
            matrix, axis=axis, bits=bits * max(rows, columns))
        output = pyrtl.Output(name="output", bitwidth=len(result))
        if axis is None:
            output <<= result
...
class TestArgMax(unittest.TestCase):
    ...
    def test_argument_maximum_basic(self):
        self.argument_maximum([[0]], 1, 1, 2, None)

    def test_argument_maximum_basic_columns(self):
        self.argument_maximum([[0]], 1, 1, 2, 0)

    def test_argument_maximum_basic_rows(self):
        self.argument_maximum([[0]], 1, 1, 2, 1)

    def test_argument_maximum_3_by_3(self):
        self.argument_maximum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, None)

    def test_argument_maximum_3_by_3_columns(self):
        self.argument_maximum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 0)

    def test_argument_maximum_3_by_3_rows(self):
        self.argument_maximum([[0, 1, 2], [3, 4, 5], [6, 7, 8]], 3, 3, 4, 1)

    def test_argument_maximum_4_by_1(self):
        self.argument_maximum([[0], [1], [0], [1]], 4, 1, 4, None)

    def test_argument_maximum_4_by_1_columns(self):
        self.argument_maximum([[0], [1], [0], [1]], 4, 1, 4, 0)

    def test_argument_maximum_4_by_1_rows(self):
        self.argument_maximum([[0], [1], [0], [1]], 4, 1, 4, 1)

    def test_argument_maximum_1_by_4(self):
        self.argument_maximum([[0, 1, 0, 1]], 1, 4, 4, None)

    def test_argument_maximum_1_by_4_columns(self):
        self.argument_maximum([[0, 1, 0, 1]], 1, 4, 4, 0)

    def test_argument_maximum_1_by_4_rows(self):
        self.argument_maximum([[0, 1, 0, 1]], 1, 4, 4, 1)

    def test_argument_maximum_random_case(self):
        rows, columns, bits, axis = random.randint(
            1, 5), random.randint(1, 5), random.randint(1, 5), random.randint(0, 2)
        if axis == 2:
            axis = None
        ...
        self.argument_maximum(matrix, rows, columns, bits, axis)

    def test_argument_maximum_wire(self):
        wire = pyrtl.Const(3)
        sum_wire = pyrtl.Output(name="output", bitwidth=len(wire))
        sum_wire <<= pyrtl.argmax(wire)
    ...
    def test_argument_maximum_string(self):

        with self.assertRaises(pyrtl.PyrtlError):
            output = pyrtl.argmax("1", axis=0)

    def test_argument_maximum_axis_out_of_bounds(self):

        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.argmax(matrix, axis=4)

    def test_argument_maximum_axis_negative(self):

        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.argmax(matrix, axis=-1)

    def test_argument_maximum_axis_string(self):

        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.argmax(matrix, "1")

    def test_argument_maximum_bits_string(self):

        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.argmax(matrix, axis=1, bits="1")

    def test_argument_maximum_bits_negative(self):
    ...
    def test_argument_maximum_bits_zero(self):

        with self.assertRaises(pyrtl.PyrtlError):
            matrix = pyrtl.Matrix(
                3, 3, 3)
            output = pyrtl.argmax(matrix, axis=1, bits=0)

    def argument_maximum(self, int_matrix, rows, columns, bits, axis):
        matrix = pyrtl.Matrix(
            rows, columns, bits, value=int_matrix, max_bits=bits * rows)
...
class TestDot(unittest.TestCase):
    ...
    def test_dot_both_wires(self):
        ...
        dot_product = pyrtl.dot(first, second)
    ...
    def test_dot_fail_int_second(self):
        with self.assertRaises(pyrtl.PyrtlError):
            first_matrix = pyrtl.Matrix(
                3, 2, 3)
            result = pyrtl.dot(first_matrix, 1)

    def test_dot_fail_int_first(self):
        with self.assertRaises(pyrtl.PyrtlError):
            first_matrix = pyrtl.Matrix(
                3, 2, 3)
            result = pyrtl.dot(1, first_matrix)
    ...
    def dot(self, first_int_matrix, rows1, columns1, bits1,
        ...
        result_matrix = pyrtl.dot(first_matrix, second_matrix)
