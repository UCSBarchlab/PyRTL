...
class TestRTLCompiledSimulationInputValidation(unittest.TestCase):
    def setUp(self):
        pyrtl.reset_working_block()
...
class TestRTLCompiledSimulationTraceWithAdder(unittest.TestCase):
    def setUp(self):
        pyrtl.reset_working_block()
        bitwidth = 3
...
class TestRTLCompiledSimulationTraceVCDWithAdder(unittest.TestCase):
    def setUp(self):
        pyrtl.reset_working_block()
        bitwidth = 3
        self.r = pyrtl.Register(bitwidth=bitwidth)
...
class TestRTLCompiledSimulationTraceWithMux(unittest.TestCase):
    def setUp(self):
        pyrtl.reset_working_block()
        bitwidth = 3
...
class TestRTLMemBlockCompiledSimulation(unittest.TestCase):
    def setUp(self):
        pyrtl.reset_working_block()
        self.bitwidth = 3
        self.addrwidth = 4
...
class TestRTLRomBlockCompiledSimulation(unittest.TestCase):
