...
class TestMultiplicationNormalCases(unittest.TestCase):
    """Tests for normal Float16 multiplication operations."""
    ...
    def test_mul_opposite_signs(self):
        ...
        self.assertEqual(self.sim.inspect("result_rne"), FLOAT16_NEG_TWO)
        self.assertEqual(self.sim.inspect("result_rtz"), FLOAT16_NEG_TWO)
...
class TestMultiplicationRounding(unittest.TestCase):
    """Tests for rounding in multiplication (RNE and RTZ)."""
...
class TestMultiplicationEdgeCases(unittest.TestCase):
    """Tests for edge cases in Float16 multiplication."""
    ...
    def test_mul_by_negative_zero(self):
        ...
        self.assertEqual(self.sim.inspect("result_rne"), FLOAT16_NEG_ZERO)
        self.assertEqual(self.sim.inspect("result_rtz"), FLOAT16_NEG_ZERO)
    ...
    def test_mul_denormal_flushed_to_zero(self):
        """Test that denormal operands are flushed to zero."""
        self.sim.step({"a": FLOAT16_DENORMAL, "b": FLOAT16_ONE})
        self.assertEqual(self.sim.inspect("result_rne"), FLOAT16_POS_ZERO)
        self.assertEqual(self.sim.inspect("result_rtz"), FLOAT16_POS_ZERO)


class TestMultiplicationOverflow(unittest.TestCase):
    """Tests for overflow handling in Float16 multiplication."""
