...
def kogge_stone(A, B):
    ...
    for i in range(1, len(A)):
        result = concat(gen_bit[i-1] ^ prop_bit[i], result)
    result = concat(gen_bit[len(A)-1], result)
    return result


def xest_kogge_stone_1():
    ...
    xvals = [1, 7, 49]
    """
    2267275008L, 1960203963, 1438786826, 3920164814L, 2497854937L,
    ...
    yvals = [3, 11, 94]
    """
    3196081010L, 2278925643L, 616604441, 2452658437L, 1635565464,
