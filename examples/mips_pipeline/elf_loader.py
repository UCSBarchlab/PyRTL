...
This simply contains some helper functions for the MIPS pipeline to build memory based on an
ELF file. C programs which output .data and .bss ELF sections may not be fully supported.
"""
